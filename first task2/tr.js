...
recognition.onerror = function(event) {
    if (event.error == 'no-speech') {
        instructions.text('لم يتم الكشف عن كلام. حاول مرة أخرى.');
    };
}
...
$('#pause-record-btn').on('click', function(e) {
    recognition.stop();
    instructions.text('توقف التعرف على الصوت مؤقتًا.');
});
...
function renderNotes(notes) {
    ...
    if (notes.length) {
        ...
        <p class="header">
          ...
          <a href="#" class="listen-note" title="Listen to Note">استمع إلى الملاحظة</a>
